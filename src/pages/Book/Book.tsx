...
import { BookTitle, Banner, MainSection, SectionTitle } from '../../components';
			...
			<div style={{ flex: 1, display: 'flex' }}>
				<MainSection>
					<Styled.Content>
						...
						Fama dos Escritores Românticos dos Estados Unidos. Simon Basset, o irresistível duque de Hastings, acaba de
						retornar a Londres depois de seis anos viajando pelo mundo. Rico, bonito e solteiro, ele é um prato cheio
						para as mães da alta sociedade, que só pensam em arrumar um bom partido para suas filhas.
						<br />
						<br />
						Simon, porém, tem o firme propósito de nunca se casar. Assim, para se livrar das garras dessas mulheres,
						precisa de um plano infalível.
